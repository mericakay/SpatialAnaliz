...
public class ResizeBar : UserControl {
	...
	public ResizeBar() {
		...
		this.MinimumSize = new Size(0, 13); // doesn't render properly at smaller heights
	...
	protected override void Dispose(bool disposing) {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            this.Name = "ResizeBar";
            this.Load += new System.EventHandler(this.ResizeBar_Load);
            this.ResumeLayout(false);

        }

        private void ResizeBar_Load(object sender, EventArgs e)
        {
